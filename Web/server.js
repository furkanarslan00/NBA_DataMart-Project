            ...
            <div class="container">
                ...
                <div class="mb-4">
                    ...
                    <select id="querySelector" class="form-select">
                        <option value="1">Query 1 - Sonraki maçları kazanma ihtimali yüksek olan ev sahibi takımlar</option>
                        <option value="2">Query 2 - Sonraki maçları kazanma ihtimali yüksek olan deplasman takımları</option>
                        <option value="3">Query 3 - En yüksek toplam skoru yapan takımlar</option>
                        <option value="4">Query 4 - X yılından sonra En iyi 3 sayı yüzdesine sahip takımlar</option>
                        <option value="5">Query 5 - En fazla galibiyet serisi olan takımlar</option>
                        <option value="6">Query 6 - Maçlarda en fazla asist yapan takımlar</option>
                        <option value="7">Query 7 - Maç kazanmada ev sahibi avantajı</option>
                        <option value="8">Query 8 - Son 5 maçta performansı düşen ev sahibi takımlar</option>
                        <option value="9">Query 9 - Son 5 maçta performansı düşen deplasman takımları</option>
                        <option value="10">Query 10 - X yılından itibaren en skorer takımlar</option>
                        <option value="11">Query 11 - Tarihteki en yüksek farkla kazanılan maçlar</option>
                        <option value="12">Query 12 - Ev Sahibi İken Ortalama Performansı En Yüksek Takımlar</option>
                        <option value="13">Query 13 - Deplasmanda İken Ortalama Performansı En Yüksek 10 Takım</option>
                        <option value="14">Query 14 - Ev Sahibi İken Ortalama Performansı En Düşük 10 Takım</option>
                        <option value="15">Query 15 - Deplasmanda İken Ortalama Performansı En Düşük 10 Takım</option>
                        </select>
                        </div>
